...
exports.registerFontClass = void 0;
var Typr = __webpack_require__(/*! typr.js */ "./node_modules/typr.js/index.js");
var TEXT_NEWLINE_REGEXP = /\r?\n/;
function registerFontClass(Zdog) {
    // Zdog.Font class
    var ZdogFont = /** @class */ (function () {
        function ZdogFont(props) {
            var _this = this;
            console.log(Typr);
            ...
            this._fetchFontResource(this.src)
                ...
                if (!font.head || !font.hmtx || !font.hhea || !font.glyf) {
                    ...
                    throw new Error("Typr.js could not parse this font (unable to find ".concat(missingFields.join(", "), ")"));
                }
                return font;
            })
                .then(function (font) {
                ...
                _this._loadCallbacks.forEach(function (callback) { return callback(); });
            })
                .catch(function (err) {
                throw new Error("Unable to load font from ".concat(_this.src, ":\n").concat(err));
            });
        }
        ZdogFont.prototype.waitForLoad = function () {
            var _this = this;
            return new Promise(function (resolve, reject) {
                // If the font is loaded, we can resolve right away
                if (_this._hasLoaded && _this._hasLoaded) {
                    resolve(true);
                }
                // Otherwise, wait for it to load
                else {
                    _this._loadCallbacks.push(resolve);
                }
            });
        };
        ZdogFont.prototype.getFontScale = function (fontSize) {
            if (!this._hasLoaded) {
                return null;
            }
            else {
        ...
        ZdogFont.prototype.measureText = function (text, fontSize) {
            var _this = this;
            if (fontSize === void 0) { fontSize = 64; }
            if (!this._hasLoaded) {
                return null;
            }
            var lines = Array.isArray(text)
                ? text
            ...
            var lineWidths = lines.map(function (line) {
                var glyphs = Typr.U.stringToGlyphs(_this.font, line);
        ...
        ZdogFont.prototype.getTextPath = function (text, fontSize, x, y, z, alignX, alignY) {
            var _this = this;
            if (fontSize === void 0) { fontSize = 64; }
            if (x === void 0) { x = 0; }
            if (y === void 0) { y = 0; }
            ...
            return lines
                ...
                var _a = _this.getTextOrigin(__assign(__assign({}, measurements), { width: lineWidths[lineIndex] }), x, y, z, alignX, alignY), _x = _a[0], _y = _a[1], _z = _a[2];
                y += lineHeight;
                var glyphs = Typr.U.stringToGlyphs(_this.font, line);
                var path = Typr.U.glyphsToPath(_this.font, glyphs, null);
                return _this._convertPathCommands(path, fontSize, _x, _y, z);
            })
                .flat();
        };
        ZdogFont.prototype.getTextGlyphs = function (text, fontSize, x, y, z, alignX, alignY) {
            var _this = this;
            if (fontSize === void 0) { fontSize = 64; }
            if (x === void 0) { x = 0; }
            if (y === void 0) { y = 0; }
            ...
            return lines
                ...
                y += lineHeight;
                return glyphs
                    .filter(function (glyph) { return glyph !== -1; })
                    .map(function (glyphId) {
                    var path = Typr.U.glyphsToPath(_this.font, glyphId);
                    var shape = {
                        translate: { x: _x, y: _y, z: _z },
                        path: _this._convertPathCommands(path, fontSize, 0, 0, 0),
                    };
        ...
        ZdogFont.prototype.getTextOrigin = function (measuement, x, y, z, alignX, alignY) {
            if (x === void 0) { x = 0; }
            if (y === void 0) { y = 0; }
            if (z === void 0) { z = 0; }
            if (alignX === void 0) { alignX = "left"; }
            if (alignY === void 0) { alignY = "bottom"; }
            var width = measuement.width, height = measuement.height, lineHeight = measuement.lineHeight;
            switch (alignX) {
                case "right":
                    x -= width;
                    break;
        ...
        ZdogFont.prototype._convertPathCommands = function (path, fontSize, x, y, z) {
            if (x === void 0) { x = 0; }
            if (y === void 0) { y = 0; }
            if (z === void 0) { z = 0; }
            var yDir = -1;
        ...
        ZdogFont.prototype._fetchFontResource = function (source) {
            return new Promise(function (resolve, reject) {
                ...
                request.onreadystatechange = function (e) {
                    if (request.readyState === 4) {
                        if (request.status >= 200 && request.status < 300) {
                            ...
                            reject("HTTP error ".concat(request.status, ": ").concat(request.statusText));
                        }
                    }
                };
                request.send(null);
...
exports.registerFontClass = registerFontClass;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.registerTextClass = void 0;
function registerTextClass(Zdog) {
    // Zdog.Text class
    var ZdogText = /** @class */ (function (_super) {
        __extends(ZdogText, _super);
        function ZdogText(props) {
            ...
            // Split props
            var font = props.font, value = props.value, fontSize = props.fontSize, textAlign = props.textAlign, textBaseline = props.textBaseline, shapeProps = __rest(props, ["font", "value", "fontSize", "textAlign", "textBaseline"]);
            // Create shape object
            _this = _super.call(this, __assign(__assign({}, shapeProps), { closed: true, visible: false, path: [{}] })) || this;
            _this._font = null;
            _this._value = value;
            _this._fontSize = fontSize;
            _this._textAlign = textAlign;
            _this._textBaseline = textBaseline;
            _this.font = font;
            return _this;
        }
        ZdogText.prototype.updateText = function () {
        ...
        Object.defineProperty(ZdogText.prototype, "font", {
            get: function () {
                return this._font;
            },
        ...
        Object.defineProperty(ZdogText.prototype, "value", {
            get: function () {
                return this._value;
            },
        ...
        Object.defineProperty(ZdogText.prototype, "fontSize", {
            get: function () {
        ...
        Object.defineProperty(ZdogText.prototype, "textAlign", {
            get: function () {
        ...
        Object.defineProperty(ZdogText.prototype, "textBaseline", {
            get: function () {
...
exports.registerTextClass = registerTextClass;


/***/ }),

/***/ "./src/ZdogTextGroup.ts":
/*!******************************!*\
  !*** ./src/ZdogTextGroup.ts ***!
  \******************************/
/***/ (function(__unused_webpack_module, exports) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.registerTextGroupClass = void 0;
function registerTextGroupClass(Zdog) {
    // Zdog.TextGroup class
    var ZdogTextGroup = /** @class */ (function (_super) {
        __extends(ZdogTextGroup, _super);
        function ZdogTextGroup(props) {
            ...
            // Split props
            var font = props.font, value = props.value, fontSize = props.fontSize, textAlign = props.textAlign, textBaseline = props.textBaseline, color = props.color, fill = props.fill, stroke = props.stroke, groupProps = __rest(props, ["font", "value", "fontSize", "textAlign", "textBaseline", "color", "fill", "stroke"]);
            // Create group object
            _this = _super.call(this, __assign(__assign({}, groupProps), { visible: false })) || this;
            _this._font = null;
            _this._value = value;
            _this._fontSize = fontSize;
            _this._textAlign = textAlign;
        ...
        ZdogTextGroup.prototype.updateText = function () {
            var _this = this;
            // Remove old children
            ...
            glyphs
                .filter(function (shape) { return shape.path.length > 0; })
                .forEach(function (shape) {
                _this.addChild(new Zdog.Shape({
        ...
        Object.defineProperty(ZdogTextGroup.prototype, "font", {
            get: function () {
                return this._font;
            },
            set: function (newFont) {
        ...
        Object.defineProperty(ZdogTextGroup.prototype, "value", {
            get: function () {
                return this._value;
            },
            set: function (newValue) {
        ...
        Object.defineProperty(ZdogTextGroup.prototype, "fontSize", {
            get: function () {
                return this._fontSize;
            },
            set: function (newSize) {
        ...
        Object.defineProperty(ZdogTextGroup.prototype, "textAlign", {
            get: function () {
                return this._textAlign;
            },
            set: function (newValue) {
        ...
        Object.defineProperty(ZdogTextGroup.prototype, "textBaseline", {
            get: function () {
                return this._textBaseline;
            },
            set: function (newValue) {
        ...
        Object.defineProperty(ZdogTextGroup.prototype, "color", {
            get: function () {
                return this._color;
            },
        ...
        Object.defineProperty(ZdogTextGroup.prototype, "fill", {
            get: function () {
                return this._fill;
            },
        ...
        Object.defineProperty(ZdogTextGroup.prototype, "stroke", {
            get: function () {
                return this._stroke;
            },
            set: function (newStroke) {
    ...
    ZdogTextGroup.optionKeys = ZdogTextGroup.optionKeys.concat([
        "color",
        "fill",
        "stroke",
        "font",
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.init = void 0;
var ZdogFont_1 = __webpack_require__(/*! ./ZdogFont */ "./src/ZdogFont.ts");
var ZdogText_1 = __webpack_require__(/*! ./ZdogText */ "./src/ZdogText.ts");
var ZdogTextGroup_1 = __webpack_require__(/*! ./ZdogTextGroup */ "./src/ZdogTextGroup.ts");
function init(Zdog) {
    ...
    (0, ZdogFont_1.registerFontClass)(Zdog);
    (0, ZdogText_1.registerTextClass)(Zdog);
    (0, ZdogTextGroup_1.registerTextGroupClass)(Zdog);
    return Zdog;
}
exports.init = init;
//   version: VERSION,
